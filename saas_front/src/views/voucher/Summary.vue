<template>
    <div>
        <el-card>
                    ...
                    <el-row type="flex" justify="space-between" align="middle">
                        ...
                        <el-col :span="9" :offset="14">
                            <el-input placeholder="请输入查询内容" prefix-icon="el-icon-search"
                                v-model="params.summaryContent"></el-input>
                        </el-col>
            ...
            <!-- 修改弹窗区域 -->
            <el-dialog title="修改摘要内容" :visible.sync="show" width="600px">
    ...
    methods: {
        async getList() {
            ...
            const res = await axios({
                url: "http://39.107.88.156:8080/sass_finance/summary/page",
                method: "get",
                params: {
                    ...this.params,
                    page: this.pageno,
        ...
        async out(row) {
            ...
            if (row.isDefault === '是') {
                ...
                const res = await axios({
                    url: "http://39.107.88.156:8080/sass_finance/summary/delete",
                    method: "delete",
                    data: data,
                headers:{
                'token':token
        ...
        async submit() {
            ...
            const res = await axios({
                url: "http://39.107.88.156:8080/sass_finance/summary/update",
                method: "put",
                data: data,
                headers:{
                'token':token
        ...
        async addsubmit() {
            ...
            const res = await axios({
                url: "http://39.107.88.156:8080/sass_finance/summary/add",
                method: "post",
                data: data,
                headers:{
                'token':token
        ...
        addopen() {
            this.addshow = true
            this.userFormData.summaryContent = ''
        }
    }
